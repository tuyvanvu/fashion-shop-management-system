...
namespace Model.EF
{
    ...
    public partial class QL_SHOPTHOITRANGEntities : DbContext
    {
        public QL_SHOPTHOITRANGEntities()
            : base("name=QL_SHOPTHOITRANGEntities")
        {
        }
        ...
        public DbSet<NGUOIDUNG_NHOMNGUOIDUNG> NGUOIDUNG_NHOMNGUOIDUNG { get; set; }
